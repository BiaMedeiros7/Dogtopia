...
<head>
    ...
    <title>Dogtopia - Algodão Doce</title>
    ...
    <div class="header-pacote">
        ...
        <div class="wrapper-pacotes">
            <div class="infos-pacote">
                <h4>Algodão Doce</h4>
                <p class="obs">4 Banhos Padrões + 1 Tosa Higiênica 
                    + Corte de Unhas + limpeza de orelhas + Penteado</p>
                <p>PELAGEM CURTA</p>
                <ul>
                    <li>Porte pequeno: R$130,00</li>
                    <li>Porte médio: R$170,00</li>
                    <li>Porte grande: R$270,00</li>
                </ul>
        <br>
                <p>PELAGEM MÉDIA</p>
                <ul>
                    <li>Porte pequeno: R$150,00</li>
                    <li>Porte médio: R$200,00</li>
                    <li>Porte grande: R$300,00</li>
                </ul>
        <br>
                <p>PELAGEM LONGA</p>
                <ul>
                    <li>Porte pequeno: R$180,00</li>
                    <li>Porte médio: R$280,00</li>
                    <li>Porte grande: R$350,00</li>
                </ul>
            
            </div>
            
            <div class="agendamento-pacote">
            <form action="Dogtopia-AlgodaoDoce.php" method="POST" id="formAgendamento">
                    <h4>Agendamento</h4>
        ...
        <script>
            ...
            form.addEventListener("submit", function(event) {
                mostrarMensagem(); //msg de sucesso
